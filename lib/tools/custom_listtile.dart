...
class CustomListTile extends StatefulWidget {
  CustomListTile({Key key, this.bookmark, this.openWebPage, this.openDetailPage, this.onChange, this.refresh, this.height}) : super(key: key);
      ...
      child: InkWell(
        ...
        child:Padding(
          ...
          child: AnimatedContainer(
            ...
            height: isOpen?(widget.height+widget.height*0.5):widget.height,
            child: Card(
                    ...
                    Align(
                      ...
                      child:  AnimatedOpacity(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            // color: Colors.pink,
                            constraints: BoxConstraints(maxHeight: 50, minHeight: 0),
                            child: Row(
